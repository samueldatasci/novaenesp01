...
def send_email(target_email, figure):
    # Credentials
    SENDER_EMAIL = "samuel.santos.magic@gmail.com"
    APP_PASSWORD = "mpas uvgl tbdz ocrd" 

    # 1. Save figure to memory buffer
    buf = io.BytesIO()
    # Use bbox_inches='tight' to ensure the plot looks good
    ...
    msg['To'] = target_email
    msg.set_content("Check out the image generated by the Python script.")

    # 3. Attach the image directly from the buffer
    msg.add_attachment(
        image_bytes, 
        maintype="image", 
        subtype="png", 
